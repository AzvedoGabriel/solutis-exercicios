package br.com.solutis.exercicio.lista.dezoito;

import java.util.Calendar;
import java.util.GregorianCalendar;
import java.util.Scanner;

public class CnjQuestDezoito {
    ...
    public static void main(String[] args) {
        ...
        double resultado = calendar.get(Calendar.YEAR) - anoNascimento;
        ...
        if (dia <= 31) {
            ...
            System.out.println("Sua idade está em torno de: " + resultado);
        } else {
