...
public class QuestaoCinco {
	...
	// tela o dia da semana correspondente.
	// Suponha que Segunda corresponde a 1 , Terça corresponde a 2, e assim por
	// diante. Utilizando Array.
	...
	public static void main(String[] args) {
		...
		String[] diasDaSemanas = { "Segunda-feira", "Terça-feira", "Quarta-feira", "Quinta-feira", "Sexta-feira",
				"Sábado", "Domingo" };
