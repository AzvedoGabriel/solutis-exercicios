...
public class QuestaoOnze {
   ...
   *    (utilize o metodo compareTo da classe String),.
    ...
    public static void comparandoPalavras(String palavra1, String palavra2) {
        ...
        if (resultado == 0) {
            ...
            if(palavra1.length() > palavra2.length()) {
                System.out.printf("Palavra maior é %s com o tamanho de: %d , " +
                        "a segunda palavra tem %d de tamanho", palavra1,palavra1.length(), palavra2.length());
            } else {
                System.out.printf("Palavra maior é %s com o tamanho de: %d , " +
                        "a segunda palavra tem %d de tamanho", palavra2,palavra2.length(), palavra1.length());
            }
        }
    }
}
